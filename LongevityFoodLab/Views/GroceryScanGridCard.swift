//
//  GroceryScanGridCard.swift
//  LongevityFoodLab
//
//  Grid view card for grocery scans
//

import SwiftUI

struct GroceryScanGridCard: View {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                GeometryReader { geometry in
                    ZStack(alignment: .bottomTrailing) {
                        // Captured Grocery Image - ensure perfect square
                        Group {
                ...
                // Product Title (max 2 lines) - smaller text
                Text(productName)
