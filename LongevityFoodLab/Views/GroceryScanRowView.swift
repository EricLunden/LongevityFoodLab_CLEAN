//
//  GroceryScanRowView.swift
//  LongevityFoodLab
//
//  List view card for grocery scans
//

import SwiftUI

struct GroceryScanRowView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog("Delete Grocery Scan", isPresented: $showingDeleteConfirmation) {
    ...
    private var productName: String {
        // Try to get itemName from analysis, fallback to foodName
        // Note: FoodAnalysis doesn't have itemName, so we'll use foodName
